...
const Upgrade = () => {
  ...
  const upgradeTiers = [
    { level: "Silver", amount: 25000, price: 50000, color: "from-gray-400 to-gray-600" },
    { level: "Gold", amount: 30000, price: 100000, color: "from-yellow-400 to-yellow-600" },
    { level: "Platinum", amount: 35000, price: 150000, color: "from-blue-400 to-blue-600" },
    { level: "Diamond", amount: 40000, price: 250000, color: "from-purple-400 to-purple-600" },
  ];
